 ...
 * @private {string}
 */
Game.START_COLOR_ = '#3c79de';

/**
 * @private {string}
 */
Game.END_COLOR_ = '#037e29';
 ...
 * @param {!google.maps.Map} map
 */
Game.prototype.createMenu_ = function(map) {
  ...
  pieceDiv.innerText = '0 / ' + Game.NUM_PIECES_;
 ...
 * @private
 */
Game.prototype.loadData_ = function() {
 ...
 * @private
 */
Game.prototype.loadDataComplete_ = function(data) {
 ...
 * @private
 */
Game.prototype.setDifficulty_ = function(difficulty) {
 ...
 * @private
 */
Game.prototype.setDifficultyStyle_ = function() {
  var styles = {
    'easy': [
      {
        stylers: [
 ...
 * @private
 */
Game.prototype.resetGame_ = function() {
 ...
 * @private
 */
Game.prototype.setCount_ = function() {
  this.pieceDiv_.innerText = this.count_ + ' / ' + Game.NUM_PIECES_;

  if (this.count_ == Game.NUM_PIECES_) {
    this.stopClock_();
  }
};
 ...
 * @private
 */
Game.prototype.stopClock_ = function() {
 ...
 * @private
 */
Game.prototype.startClock_ = function() {
  this.stopClock_();
 ...
 * @private
 */
Game.prototype.addRandomCountries_ = function() {
  // Shuffle countries
  this.countries_.sort(function() {
    return Math.round(Math.random()) - 0.5;
  });

  var countries = this.countries_.slice(0, Game.NUM_PIECES_);
 ...
 * @private
 */
Game.prototype.addCountry_ = function(country) {
  var options = {
    strokeColor: Game.START_COLOR_,
    strokeOpacity: 0.8,
    strokeWeight: 2,
    fillColor: Game.START_COLOR_,
    fillOpacity: 0.35,
    geodesic: true,
    map: this.map_,
    draggable: true,
 ...
 * @returns {boolean}
 */
Game.prototype.boundsContainsPoly_ = function(bounds, poly) {
 ...
 * @private
 */
Game.prototype.replacePiece_ = function(poly, country) {
  var options = {
    strokeColor: Game.END_COLOR_,
    fillColor: Game.END_COLOR_,
    draggable: false,
    zIndex: 1,
 ...
 * @private
 */
Game.prototype.checkPosition_ = function(poly, country) {
 ...
 * @private
 */
Game.prototype.removeCountries_ = function() {
